...
Тестирование сайта можно произвести с помощью VPN для изменения местоположений и форматов дат. 
 ...
 ***Поиск:***
 ...
 Поиск с минимальным кол-вом символов и отображение корректного сообщения,когда запрос менее N(3-х) символов|  ✅           |                |
...
3. Ссылки на пользовательские соглашения
